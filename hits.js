...
function runStats(attacker, defender, inAssaultPhase, isWhiteScars){
    ...
    if (inAssaultPhase){
        attackerDamage = isWhiteScars ? attackerDamage + 1 : attackerDamage;
        attackerAP = isWhiteScars ? attackerAP + 1 : attackerAP;
    ...
    (function getDamage(){
        ...
        if (defender.wounds === attackerDamage ||
            ...
            document.getElementById('attacksPerDefender').innerText = Math.round(attacksPerDefender * 100)/ 100;
            console.log('defender wounds ', defender.wounds);
            console.log('attacker damage ', attackerDamage);
